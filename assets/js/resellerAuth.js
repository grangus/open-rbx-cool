...
$(document).ready(async () => {
    ...
    if (token) {
        ...
        if (response.status == 200) return document.location.href = '/reseller/home';
    }
    ...
    const postLogin = async () => {
        ...
        let response = await fetch(`${protocol}//api.rbx.cool/reseller/login`, {
            method: 'POST',
            headers: {
        ...
        localStorage.setItem('rtoken', json.data.token);
        document.location.href = '/reseller/home';
    };
