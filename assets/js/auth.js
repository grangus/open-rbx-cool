$(document).ready(async () => {
    ...
    if (token) {
        ...
        if (response.status == 200) return document.location.href = '/earn';
    }
    ...
    const postRegister = async () => {
        ...
        let response = await fetch(`${protocol}//api.rbx.cool/authentication/register`, {
            method: 'POST',
            headers: {
